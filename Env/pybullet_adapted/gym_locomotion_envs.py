...
class HalfCheetahBulletEnv(WalkerBaseBulletEnv):
  ...
  def __init__(self, render=False):
    ...
    self._body_id = self.robot.objects[0]
    self._plane_id = self.stadium_scene.ground_plane_mjcf[0]
    self._foot_back_link_idx = 8+1
    self._foot_front_link_idx = 14+1
  ...
  def step(self, a):
      ...
      for _ in range(action_repeat):
        state, reward, done, info = WalkerBaseBulletEnv.step(self, a)
